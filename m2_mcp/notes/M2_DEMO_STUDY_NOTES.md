...
### What it teaches
The same agentic tool loop as `github_agent_client.py`, but connecting to our agentic real estate MCP servers over SSE (HTTP) instead of stdio. Proves the agent code is transport-agnostic — only the connection setup changes.
...
=================================================================
SSE MCP AGENT
An LLM that decides which agentic real estate tools to call over HTTP
=================================================================
