...
root_agent = LlmAgent(
    name="basic_agent",
    model=MODEL,
    description="A simple agentic real estate assistant that estimates property values.",
    instruction=(
        "You are a helpful agentic real estate assistant. When asked about a property, "
