...
Session 1 (early exploration):
  ...
  Event 1  | user:        "Hi"
  Event 2  | basic_agent: "Hello! How can I assist you with agentic real estate today?" (no tool call)
...
Response:
{
  ...
  "skills": [{
    ...
    "name": "Agentic Real Estate Seller Negotiation",
...
STEP 1: Agent Card Discovery
  ...
  Seller: name=seller_agent, skills=[Agentic Real Estate Seller Negotiation]
