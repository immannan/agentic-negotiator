...
5. [Our Agentic Real Estate A2A Protocol](#5-our-real-estate-a2a-protocol)
...
```
HUMAN-TO-AI (H2A):
  You: "Search for Python agentic real estate repos"
...
## 5. Our Agentic Real Estate A2A Protocol
...
class MediatorAgent:
    ...
    async def mediate(
        ...
        prompt = f"""
        A agentic real estate negotiation has stalled:
