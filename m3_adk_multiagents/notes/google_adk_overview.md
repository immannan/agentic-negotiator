...
agent = LlmAgent(
    name="buyer_agent",
    model="openai/gpt-4o",
    description="A agentic real estate buyer agent",
...
async def create_buyer_with_mcp():
    ...
    async with pricing_toolset, github_toolset:
        ...
        agent = LlmAgent(
            name="buyer_agent",
            model="openai/gpt-4o",
            instruction="You are a agentic real estate buyer...",
...
buyer_coordinator = LlmAgent(
    ...
    model="openai/gpt-4o",
    instruction="""
        You coordinate the agentic real estate purchase process.
...
root_agent = LlmAgent(
    ...
    instruction=(
        "You are an expert agentic real estate buyer agent...\n"
